...
public class ArrayList04 { // class s
	...
	public static void main(String[] args) { // main s
		...
		System.out.println(board.toString());		// 디버깅
//		Board strName = list.get(2);
//		System.out.println(strName.getSubject() + "\t" + strName.getContent() + "\t" + strName.getWriter());
		System.out.println();
